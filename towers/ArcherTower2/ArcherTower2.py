...
class ArcherTower2(pygame.sprite.Sprite):
    def __init__(self, win):
        ...
        self.images_archers = []
        for i in range(1, 7):
            self.images_archers.append(pygame.transform.scale(pygame.image.load('towers/ArcherTower2/archer_1_' + str(i) + '.png'), (35, 35)))
        self.images_tower = [pygame.transform.scale(pygame.image.load('towers/ArcherTower2/tower_1_2.png'), (120, 115))]
        self.img_count = 0
        self.count = 0
        self.power = 75
